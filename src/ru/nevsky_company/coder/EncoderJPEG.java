...
public class EncoderJPEG {
    ...
    public void run() {
        ...
        double hideLay1[] = hideLay(getLay(lay, 0)); // свернули слои
        double hideLay2[] = hideLay(getLay(lay, 1));
        double hideLay3[] = hideLay(getLay(lay, 2));
    ...
    private double[][] getLay(double lay[][], int numberLay) {
